            ...
            <div className="bg-gray-50 rounded-2xl p-6 sticky top-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-gray-200">
                  ...
                  <span className="font-bold text-gray-800">{localizedCourse.schedule?.time || 'غير محدد'}</span>
                </div>
                <div className="flex items-center justify-between py-3">
                  <span className="text-gray-600">نظام الدراسة</span>
                  <span className="font-bold text-gray-800">{localizedCourse.schedule?.mode || 'غير محدد'}</span>
                </div>
              </div>
